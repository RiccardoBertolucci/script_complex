...
def main():
	...
	while not rospy.is_shutdown():
		...
		os.system("rosrun baxter_examples joint_trajectory_file_playback.py -f /home/berto/ros_ws/src/articulated_object_manipulation/actions/right_rotate_right_flat_down.rec")
		
		right.open([])
		
		out_file.write("Time: "+ str(rospy.Time.now()) + ": starting right_leave_right_down\n")
		
		os.system("rosrun baxter_examples joint_trajectory_file_playback.py -f /home/berto/ros_ws/src/articulated_object_manipulation/actions/right_leave_right_down.rec")
